...
const chess = {
  ...
  // strBoard: [
  //     7, 7, 7, 7, 7,  7,  7,  7,  7,   7,  7,  7,  7, 7, 7,
  //     7, 7, 7, 7, 7,  'R', 'N', 'B', 'Q', 'K', 'B', 'N', 'R', 7, 7,
  //     7, 7, 7, 7, 7,  'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 7, 7,
  //     7, 7, 7, 7, 7, '.', '.', '.', '.', '.', '.', '.', '.', 7, 7,
  //     7, 7, 7, 7, 7, '.', '.', '.', '.', '.', '.', '.', '.', 7, 7,
  //     7, 7, 7, 7, 7, '.', '.', '.', '.', '.', '.', '.', '.', 7, 7,
  //     7, 7, 7, 7, 7, '.', '.', '.', '.', '.', '.', '.', '.', 7, 7,
  ...
  // __generateMoves = color => {

  // },
  // __checkForCheck = color => {

  // },
  // __moveResInCheck = move => {
...
console.log(chess.generateKnightMoves(chess.board, 22));
